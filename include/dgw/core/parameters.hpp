...
struct VGParams {
    Real theta_r, theta_s, alpha, n;
};

constexpr VGParams vg_sand = {0.045, 0.43, 14.5, 2.68};
constexpr VGParams vg_loamy_sand = {0.057, 0.41, 12.4, 2.28};
constexpr VGParams vg_sandy_loam = {0.065, 0.41, 7.5, 1.89};
constexpr VGParams vg_loam = {0.078, 0.43, 3.6, 1.56};
constexpr VGParams vg_silt = {0.034, 0.46, 1.6, 1.37};
constexpr VGParams vg_silt_loam = {0.067, 0.45, 2.0, 1.41};
constexpr VGParams vg_sandy_clay_loam = {0.100, 0.39, 5.9, 1.48};
constexpr VGParams vg_clay_loam = {0.095, 0.41, 1.9, 1.31};
constexpr VGParams vg_silty_clay_loam = {0.089, 0.43, 1.0, 1.23};
constexpr VGParams vg_sandy_clay = {0.100, 0.38, 2.7, 1.23};
constexpr VGParams vg_silty_clay = {0.070, 0.36, 0.5, 1.09};
constexpr VGParams vg_clay = {0.068, 0.38, 0.8, 1.09};
